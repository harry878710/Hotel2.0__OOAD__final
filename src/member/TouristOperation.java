...
//		// System.out.println("Records created successfully");
	...
	public static int userLogin(String userId,String password) {
		return MemberOperation.userLogin(userId, password, "user");
...
//		return 4;
	...
	public static void showAllUser() {
		MemberOperation.showAllUser("user");
//		Connection c = null;
//		Statement stmt = null;
//		try {
//			Class.forName("org.sqlite.JDBC");
...
//		// System.out.println("Operation done successfully");
	...
	public static int changePassword(String id, String oldPass, String newPass,String repeat) {
		return MemberOperation.changePassword(id, oldPass, newPass, repeat,"user");
//		if (!hasUser(id)) {
...
//		// System.out.println("Operation done successfully");
	...
	public static boolean checkPassword(String id, String password) {
		return MemberOperation.checkPassword(id, password,"user");
//		if (!hasUser(id)) {
//			return false;
//		}
...
//		return toReturn;
	...
	public static boolean hasUser(String id) {
		return MemberOperation.hasUser(id, "user");
//		boolean get = false;
//		Connection c = null;
//		Statement stmt = null;
//		try {
...
//		// System.out.println("Operation done successfully");
	...
	public static boolean anyoneLoggedin() {
		return MemberOperation.anyoneLoggedin("user");
//		for (int i = 0; i < UserList.userList.size(); i++) {
...
//		return false;
	...
	public static void everyOneloggedOut() {
		MemberOperation.everyOneloggedOut("user");
//		for (int i = 0; i < UserList.userList.size(); i++) {
...
//		}
	...
	public static String whoIsLoggedin() {
		return MemberOperation.whoIsLoggedin("user");
//		for (int i = 0; i < UserList.userList.size(); i++) {
//			if (UserList.userList.get(i).isLogin()) {
